...
if (isset($_POST['add_country'])) {
    ...
    if (!empty($description)) {
        if ($model->addCountry($description)) {
...
<head>
    ...
    <title>Add Country – Vehicle Fleet Manager</title>
    ...
    <style>
        ...
        .country-table tbody tr:hover { background: #f8f9fa; }
        ...
        .country-table tbody tr:last-child { border-bottom: none; }
            ...
            <div class="form-panel">
                <form method="POST">
                    ...
                    <div class="btn-row">
                        ...
                        <button type="submit" name="add_country" class="btn-add">
                            Add
                        </button>
                    </div>
                </form>
                ...
                <div class="table-scroll">
                    <table class="country-table">
                        ...
                        <tbody>
                            ...
                            <?php if ($count === 0): ?>
                            <tr>
                                <td class="empty-msg">No countries found.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
