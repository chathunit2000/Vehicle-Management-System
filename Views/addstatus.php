...
if (isset($_POST['add_status'])) {
    ...
    if (!empty($description)) {
        if ($model->addStatus($description)) {
            $success = "Vehicle status added successfully.";
        } else {
            $error = "Failed to add vehicle status.";
        }
    } else {
...
<head>
    ...
    <title>Add Vehicle Status – Vehicle Fleet Manager</title>
    ...
    <div class="page-card">
        ...
        <div class="page-body">
            ...
            <div class="form-panel">
                <form method="POST">
                    <label for="description">Vehicle Status</label>
                    <input type="text"
                           id="description"
                           name="description"
            ...
            <div class="table-panel">
                <h6>Existing Vehicle Statuses</h6>
                <div class="table-scroll">
                    <table class="data-table">
                        <thead>
                            <tr><th>Vehicle Status</th></tr>
                        </thead>
                        <tbody>
                            <?php
                            $count = 0;
                            while ($row = $statuses->fetch(PDO::FETCH_ASSOC)):
                                $count++;
                            ?>
                            <tr>
                                <td>
                            ...
                            <?php endwhile; ?>
                            <?php if ($count === 0): ?>
                            <tr><td class="empty-msg">No vehicle statuses found.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
