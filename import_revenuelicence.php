...
if (isset($_GET['template'])) {
    ...
    header('Content-Disposition: attachment; filename="revenue_licence_template.csv"');
    echo "Reg No,Institute,Serial No,From Date (YYYY-MM-DD),Expiry Date (YYYY-MM-DD),Amount,Remarks\r\n";
    echo "WPKY-5249,WESTERN PROVINCE,REV-001,2024-01-01,2025-01-01,3000,\r\n";
    exit;
}

// Load institutes for revenue licence (typeid=2)
$institutes   = $db->query("SELECT id, description FROM INSTITUTE WHERE typeid = 2 ORDER BY description ASC")->fetchAll(PDO::FETCH_ASSOC);
$instituteMap = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csvfile'])) {
    ...
    if ($file['error'] !== UPLOAD_ERR_OK) {
        ...
        $stmt = $db->prepare("INSERT INTO LICENCE (regno, licencetypeid, instituteid, serialno, fromdate, expdate, amount, remarks, status)
                              VALUES (:regno, 2, :instituteid, :serialno, :fromdate, :expdate, :amount, :remarks, 1)");
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-light fw-semibold px-4">Upload</button>
                                    <a href="?template=1" class="btn btn-outline-light fw-semibold">Download Template</a>
                                </div>
                        ...
                        <div class="card-body p-3">
                            <table class="table table-sm table-bordered mb-0 small">
                                ...
                                <tbody>
                                    ...
                                    <tr><td>2</td><td>Institute</td><td>WESTERN PROVINCE</td></tr>
                                    <tr><td>3</td><td>Serial No</td><td>REV-001</td></tr>
                                    <tr><td>4</td><td>From Date</td><td>2024-01-01</td></tr>
                                    <tr><td>5</td><td>Expiry Date</td><td>2025-01-01</td></tr>
                                    <tr><td>6</td><td>Amount</td><td>3000</td></tr>
                    ...
                    <?php elseif (empty($errors)): ?>
                        <div class="d-flex align-items-center justify-content-center h-100 text-muted" style="min-height:200px;">
                            <div class="text-center">
                                ...
                                <p class="mb-0">Upload a CSV file to import revenue licence records.<br>
